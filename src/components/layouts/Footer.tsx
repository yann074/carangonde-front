  ...
  <div className="container mx-auto px-4 py-8">
    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
      ...
      <div className="space-y-4">
        ...
        <p className="text-gray-500 text-sm">
          Plataforma de gerenciamento de eventos que simplifica sua vida.
        </p>
      ...
      <div>
        ...
        <ul className="mt-4 space-y-2">
          <li><a href="#" className="text-gray-500 hover:text-purple-600 text-sm">Início</a></li>
          <li><a href="#" className="text-gray-500 hover:text-purple-600 text-sm">Eventos</a></li>
          <li><a href="#" className="text-gray-500 hover:text-purple-600 text-sm">Criar Evento</a></li>
          <li><a href="#" className="text-gray-500 hover:text-purple-600 text-sm">Sobre nós</a></li>
          <li><a href="#" className="text-gray-500 hover:text-purple-600 text-sm">Contato</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul className="mt-4 space-y-2">
          <li className="flex items-start">
            ...
            <span className="text-gray-500 text-sm">contato@eventflow.com</span>
          </li>
          <li className="flex items-start">
            <svg className="h-5 w-5 text-gray-400 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
            </svg>
            <span className="text-gray-500 text-sm">(11) 98765-4321</span>
          </li>
          <li className="flex items-start">
            <svg className="h-5 w-5 text-gray-400 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <span className="text-gray-500 text-sm">São Paulo, SP</span>
          </li>
        </ul>
      </div>
    ...
    <div className="mt-12 border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center">
      ...
      <div className="mt-4 md:mt-0 flex space-x-6">
        ...
        <a href="#" className="text-gray-400 hover:text-gray-500 text-sm">Cookies</a>
      </div>
    </div>
  </div>
</footer>
